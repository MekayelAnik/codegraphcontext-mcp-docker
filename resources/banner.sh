...
print_ascii_art() {
    ...
    printf "${NAVY_BLUE}    /SSSSSS                  /SS            /SSSSSS                               /SS        /SSSSSS                        /SS                           /SS        ${NC} \n"
    printf "${NAVY_BLUE}   /SS__  SS                | SS           /SS__  SS                             | SS       /SS__  SS                      | SS                          | SS        ${NC} \n"
    printf "${NAVY_BLUE}  | SS  \__/  /SSSSSS   /SSSSSSS  /SSSSSS | SS  \__/  /SSSSSS  /SSSSSS   /SSSSSS | SSSSSSS | SS  \__/  /SSSSSS  /SSSSSSS  /SSSSSS    /SSSSSS  /SS   /SS /SSSSSS      ${NC} \n"
    printf "${NAVY_BLUE}  | SS       /SS__  SS /SS__  SS /SS__  SS| SS /SSSS /SS__  SS|____  SS /SS__  SS| SS__  SS| SS       /SS__  SS| SS__  SS|_  SS_/   /SS__  SS|  SS /SS/|_  SS_/      ${NC} \n"
    printf "${NAVY_BLUE}  | SS      | SS  \ SS| SS  | SS| SSSSSSSS| SS|_  SS| SS  \__/ /SSSSSSS| SS  \ SS| SS  \ SS| SS      | SS  \ SS| SS  \ SS  | SS    | SSSSSSSS \  SSSS/   | SS        ${NC} \n"
    printf "${NAVY_BLUE}  | SS    SS| SS  | SS| SS  | SS| SS_____/| SS  \ SS| SS      /SS__  SS| SS  | SS| SS  | SS| SS    SS| SS  | SS| SS  | SS  | SS /SS| SS_____/  >SS  SS   | SS /SS    ${NC} \n"
    printf "${NAVY_BLUE}  |  SSSSSS/|  SSSSSS/|  SSSSSSS|  SSSSSSS|  SSSSSS/| SS     |  SSSSSSS| SSSSSSS/| SS  | SS|  SSSSSS/|  SSSSSS/| SS  | SS  |  SSSS/|  SSSSSSS /SS/\  SS  |  SSSS/    ${NC} \n"
    printf "${NAVY_BLUE}   \______/  \______/  \_______/ \_______/ \______/ |__/      \_______/| SS____/ |__/  |__/ \______/  \______/ |__/  |__/   \___/   \_______/|__/  \__/   \___/      ${NC} \n"
